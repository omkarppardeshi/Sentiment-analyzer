...
.border-positive {
  --tw-border-opacity: 1;
  border-color: hsl(142 76% 36% / var(--tw-border-opacity, 1));
}
.border-primary\/20 {
...
.bg-negative {
  --tw-bg-opacity: 1;
  background-color: hsl(0 84% 60% / var(--tw-bg-opacity, 1));
}
.bg-positive {
  --tw-bg-opacity: 1;
  background-color: hsl(142 76% 36% / var(--tw-bg-opacity, 1));
}
.bg-positive-foreground {
  --tw-bg-opacity: 1;
  background-color: hsl(142 76% 96% / var(--tw-bg-opacity, 1));
}
.bg-primary {
...
.text-negative-foreground {
  --tw-text-opacity: 1;
  color: hsl(0 84% 96% / var(--tw-text-opacity, 1));
}
.text-positive {
  --tw-text-opacity: 1;
  color: hsl(142 76% 36% / var(--tw-text-opacity, 1));
}
.text-positive-foreground {
  --tw-text-opacity: 1;
  color: hsl(142 76% 96% / var(--tw-text-opacity, 1));
}
.text-primary {
 ...
 * - Dark mode: CSS-based dark mode with class strategy
 */
